...
class DepartmentController extends AppBaseController
{
    ...
    {
        $employees = $this->employeeRepository->all()->pluck('name','id');
        foreach ($employees as $id => $name) {
            $list[$id] = $name;
        }
        return view('departments.create')->with('list',$list);
    }
    ...
    public function edit($id)
    {
        ...
        return view('departments.edit')->with('department', $department)->with('list',$list);
    }
